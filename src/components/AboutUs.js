            ...
            <div className="container">
                <div className="row">
                    <div
                        ...
                        <img src="https://leonardomagalhaes.com/wp-content/uploads/2021/11/Camada-2-1.png"
                            className="img-fluid" />
                    </div>
                    <div className="col-md-6 align-self-center order-md-2 order-1 mb-md-0 mb-4">
                        <div className="title container-text">
                            <h2 className="app-text--general">Desenvolvedor&nbsp;
                                <span id="typed-text" className="typed-text"></span>
                                <span id="cursor" className="cursor">&nbsp;</span>
                            </h2>
                        </div>
                        <h6 className="subtitle">"Pegue o impossível, torne-o óbvio" - dê-me uma causa nobre e eu a farei acontecer</h6>
                        <p className="text-justify">
                            Eu sou um desenvolvedor back-end (e ocasionalmente front-end), estudante de Administração Empresarial e apaixonado por tecnologia, desenvolvo pequenos projetos desde os 14 anos de idade.
                            <br /><br />
